...
//		setBackground(Color.lightGray);
		...
		topBox.setFont(new Font("Dialog", Font.PLAIN, 12));
		topWrapper = new Wrapper(topBox, "BeanBox", "sun.beanbox.BeanBox");
		topWrapper.setFont(new Font("Dialog", Font.PLAIN, 12));
	...
	//*/
		...
		setBounds(230, 20, 700, 750);
		new WindowCloser(this, true);
		show();

	//*
   		propertySheet = new PropertySheet(topWrapper, 940, 20);
